...
\begin{figure}[!h]
  \centering
    \includegraphics[scale=0.4]{img/textareadiff.png}
...
\\\\
Con esto ya tenemos el comportamiento mas esencial cubierto y encapsulado, ahora necesitamos
que el usuario pueda crear textos en vez de modificar uno ya existente.
